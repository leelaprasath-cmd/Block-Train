  ...
  return (
    <>
      ...
      <div className="absolute top-20 right-6 z-30 select-none pointer-events-auto font-mono">
        <div className="flex items-center gap-1 occ-dock-glass p-1 rounded-xl shadow-lg text-xs">
          <div className="flex items-center gap-1 px-2.5 text-slate-500 text-[11px] font-bold">
      ...
      <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-30 flex flex-col items-center gap-2 max-w-[96vw] pointer-events-auto select-none font-mono">
        <div className="flex items-center gap-2 occ-dock-glass p-1.5 rounded-2xl shadow-xl overflow-x-auto max-w-full no-scrollbar">
          ...
          <div className="border-l border-slate-200 pl-2 shrink-0 flex items-center gap-1.5">
            <button
              onClick={resetCorridorView}
              className="px-3 py-1 text-[11px] font-bold text-blue-700 hover:text-blue-800 bg-blue-50 hover:bg-blue-100 border border-blue-200 rounded-lg transition-all uppercase tracking-wider shadow-xs"
